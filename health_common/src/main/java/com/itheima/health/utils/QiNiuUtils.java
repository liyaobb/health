...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "tv5l_lYj4DlrmvpC-gnvu7DbTfpLldrNJaEle86h";
    private static final String SECRETKEY = "-q8Hnk4moxZ_I60cFFst1KRKTLtxMNpdg-m83BAK";
    private static final String BUCKET = "liyaobb";
    public static final String DOMAIN= "http://qiqfwo9t8.hd-bkt.clouddn.com/";
